...
def main(date: datetime.date):
    ...
    processos = [(f"Limpando e trnsformando dados de comissão {date} - crefisa", cleaningTransforma_comission.crefisaCleaningComission),
                 (f"Atualizando tabelas do banco de dados {date} - crefisa", cleaningTransforma_comission.load_crefisa_comission),
                 ...
                 (f"Limpando e trnsformando dados de produção {date} - crefisa", cleaningTransform_contracts.crefisaCleaningContracts),
