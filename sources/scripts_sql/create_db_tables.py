...
query_create_contrato = (
    ...
    create table if not exists contrato(
        ...
        codigo_usuario_digitador varchar(50),
        ...
        FOREIGN KEY (nome_tabela) REFERENCES tabela(codigo_tabela),
        FOREIGN KEY (nome_banco) REFERENCES banco(nome_banco),
        FOREIGN KEY (codigo_usuario_digitador) REFERENCES usuario_digitador_banco(codigo_usuario_digitador),
