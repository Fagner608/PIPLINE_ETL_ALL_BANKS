...
def load_production(date: datetime.date):
    ...
    updateStaginArea().upDatating(bank='BANCO MERCANTIL DO BRASIL')
    ...
    total_dict[5]['nome_convenio'] = 'nomeconvenio'
    total_dict[5]['codigo_convenio'] = 'codigoconvenio'
    ...
    # Tabela tabela
    total_dict[8]['nome_tabela'] = 'nomeproduto'
    total_dict[8]['codigo_tabela'] = 'codigoproduto'
...
# Debug
# CleaningProduction(date = datetime.date.today())
# load_production(date = datetime.date.today())