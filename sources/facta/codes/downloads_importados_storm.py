...
class download_importados_storm():
    ...
    def tqdm_bar(self, bank: str, date = datetime.date):
        ...
        processos = [("Download do relatório de importacao do facta", self.dowloadImportation)]
...
# Debug
# date = datetime.date(2024, 8, 13)
# download_importados_storm().tqdm_bar(date = date, bank = 'facta')