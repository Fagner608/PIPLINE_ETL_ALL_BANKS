...
class download_importados_storm():
    ...
    def tqdm_bar(self, bank: str, date = datetime.date):
        ...
        processos = [("Download do relatório de importacao do Banrisul", self.dowloadImportation)]
...
# download_importados_storm().tqdm_bar(date_work = date, bank = 'BANCO BANRISUL')